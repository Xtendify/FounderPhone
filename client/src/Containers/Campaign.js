...
class Campaign extends Component {
	...
	selectContact = (id, number) => {
		...
		let sendCampaignContactCopy = this.state.sendCampaignContact;
		sendCampaignContactCopy.push(number);
		this.setState({
			selectedContacts: selectedContactsCopy,
			sendCampaignContact: sendCampaignContactCopy,
		});
	};
	...
	openAddContactDialog = () => {
		this.setState({
			openAddContactDialog: !this.state.openAddContactDialog,
		});
	};
			...
			<Fragment>
				<Container maxWidth="lg" className={classes.container}>
					...
					<Grid container direction="row" spacing={2}>
						...
						<Grid item xs={8}>
							<TemplateMessage
								sendAllCallback={this.sendAllCallback}
							/>
						</Grid>
					</Grid>
				</Container>
				...
				>
					...
					<DialogContent>
						<DialogContentText id="alert-dialog-description">
							We'll send this message to {selectedContacts.length}{' '}
							contact(s)
						</DialogContentText>
					</DialogContent>
					<DialogActions>
				...
				>
					...
					<DialogContent>
						...
						<div
							className={classes.accountManagerFormControlWrapper}
						>
							<FormControl
								variant="outlined"
