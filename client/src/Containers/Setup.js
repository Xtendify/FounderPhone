			...
			<Grid item className={classes.marginBottom30}>
				...
				>
					<Grid item className={classes.width100}>
						...
						>
							You can subscribe to be notified of events in
							FounderPhone (for example, when a new message is
							sent or received) at a URL of your choice.
						</Typography>
				...
				<Container className={classes.container}>
										...
										phoneNumber ? (
											...
											<Fragment>
												...
												>
													...
													continue. Then click Add to
													Slack. We'll generate a
													phone number that you can
													give to your customers! For
													...
													<FormControlLabel
														...
														control={
															<Checkbox
																...
																className={
																	classes.privateChannelCheckbox
																}
																onChange={
																	this
																		.handleCreatePrivateChannel
									...
									>
										...
										>
											...
											>
												...
												>
													Any texts sent to this
													number will be forwarded to
													your Slack. Share it with
													your customers
												</Typography>
												{(currentPlan ===
													planTypes.PAID ||
					...
					>
						<DialogTitle id="alert-dialog-title">
							You should have text forwarding to Slack working
							now!
						</DialogTitle>
						<DialogContent>
							<DialogContentText id="alert-dialog-description">
								Text {formattedPhoneNumber} and head to your
								Slack to see if a new channel was created with
								the forwarded SMS
							</DialogContentText>
						</DialogContent>
						<DialogActions>
