					...
					>
						...
						>
							<Grid item className={classes.width100}>
								...
								>
									We'll only create a channel in your Slack
									once they respond. Use &#123;firstname&#125;
									and &#123;lastname&#125; in your message and
									we'll replace them with your contact's
									actual names where available
								</Typography>
								<Fragment>
									<Grid
										container
